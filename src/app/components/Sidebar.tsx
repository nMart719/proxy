...
const navigation: NavigationItem[] = [
  ...
  {
    name: "Створити сервер",
    href: "/dashboard/createServ",
    icon: GlobeAltIcon,
    current: false,
  },
];
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1 flex-col">
                ...
                >
                  <div className="flex w-16 justify-center py-5 bg-blackColor">
                    <button
                      type="button"
                      className="-m-2.5 p-2.5 'flex-row justify-between"
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        ...
        <div className="flex grow flex-col gap-y-5 overflow-y-auto  px-6">
          <div className="flex flex-row h-16 shrink-0 justify-between items-end">
            <div className="font-bold text-3xl bg-gradient-to-b from-textColor to-borderColor text-transparent bg-clip-text">
              {username}
            </div>
            <button
              onClick={() => {
              ...
              className="pb-1 hover:!bg-transparent text-textColor hover:text-borderColor "
            >
              <svg
